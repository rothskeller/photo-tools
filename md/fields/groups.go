...
func (f *groupsField) CheckValues(ref filefmt.FileHandler, tgt filefmt.FileHandler) (res strmeta.CheckResult) {
	if res = strmeta.CheckGroups(ref, tgt); res == strmeta.ChkPresent {
