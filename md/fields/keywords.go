...
func (f *keywordsField) CheckValues(ref filefmt.FileHandler, tgt filefmt.FileHandler) (res strmeta.CheckResult) {
	if res = strmeta.CheckKeywords(ref, tgt); res == strmeta.ChkPresent {
